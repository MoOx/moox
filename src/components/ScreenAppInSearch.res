...
let make = () =>
  <SpacedView>
    ...
    <Text
      style={
        open Style
        style(~fontSize=22., ~color="#356FEF", ~textDecorationLine=#underline, ())
      }>
    ...
    <Text
      ...
      {"You need an awesome website that is fast & appear in search results? You got lucky, I can help."->React.string}
    </Text>
    <Spacer size=S />
    <Row>
      <Spacer />
      <View
        ...
        <Text
          style={
            open Style
            style(~fontSize=20., ~color="#356FEF", ~textDecorationLine=#underline, ())
          }>
          {"Fast"->React.string}
        </Text>
        <Spacer size=XS />
        <Text
          ...
          {"I know how to build fast & beautiful webapps in all browsers."->React.string}
        </Text>
      </View>
      <Spacer size=S />
      <View
        ...
        <Text
          ...
          {"I can make your websites looking good without compromise."->React.string}
        </Text>
      </View>
    </Row>
    <Spacer />
    ...
    <Text
      ...
      <Text
        style={
          open Style
          style(~color=Consts.Colors.lightGrey, ())
        }>
        {j`⭑⭑⭑⭑`->React.string}
      </Text>
    </Text>
    ...
    <Row>
      ...
      <View
        ...
        <Text
          ...
          {"Your sites & apps need to be fast, I know how to make it them fast."->React.string}
        </Text>
      </View>
      <Spacer size=S />
      <View
...
Engineer: but it's kind of !important"`->React.string}
    </Text>
  </SpacedView>
