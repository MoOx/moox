      ...
      <View>
        <View
          ...
          <svg
            ...
            <defs>
              <linearGradient x1="0%" y1="0%" x2="100%" y2="100%" id="apple-m1-linearGradient-1">
                <stop stopColor="#FFA456" offset="0%" />
                <stop stopColor="#FFA456" stopOpacity="0" offset="100%" />
              </linearGradient>
              <linearGradient x1="100%" y1="0%" x2="50%" y2="50%" id="apple-m1-linearGradient-2">
                <stop stopColor="#00B1EE" offset="0%" />
                <stop stopColor="#00B1EE" stopOpacity="0" offset="100%" />
              </linearGradient>
              <linearGradient x1="0%" y1="100%" x2="50%" y2="50%" id="apple-m1-linearGradient-3">
                <stop stopColor="#EE0000" offset="0%" />
                <stop stopColor="#EE00E1" stopOpacity="0" offset="100%" />
              </linearGradient>
              <linearGradient x1="100%" y1="100%" x2="50%" y2="50%" id="apple-m1-linearGradient-4">
