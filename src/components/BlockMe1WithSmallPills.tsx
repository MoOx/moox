    ...
    <Me>
      ...
      >
        ...
        <Parallax
          ...
          transforms={pTransforms(-20, 10, 0.2)}
        >
          <Pill pre="Professional" title="Mobile Developer" year={2018} />
        </Parallax>
        <Parallax
