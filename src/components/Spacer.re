    ...
    Style.(
      {
        ...
        "normalMarginHorizontal": style([
          marginHorizontal(Pt(normal /. 2.))
        ]),
        "normalMarginVertical": style([
          marginVertical(Pt(normal /. 2.))
        ]),
        "smallMargin": style([
        ...
        "smallMarginVertical": style([
          marginVertical(Pt(small /. 2.))
        ]),
        "smallMarginHorizontal": style([
          marginHorizontal(Pt(small /. 2.))
        ]),
        "largeMargin": style([
        ...
        "largeMarginHorizontal": style([
          marginHorizontal(Pt(large /. 2.))
        ]),
        "largeMarginVertical": style([
          marginVertical(Pt(large /. 2.))
        ])
      }
    )
