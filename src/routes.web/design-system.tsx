...
import BtnSpecimens from "@/components/BtnSpecimens";
      ...
      <Container gap="m">
        ...
        <SpacedView style={styles.section}>
          ...
          <P>
            ...
            proper spacing. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod
        ...
        <SpacedView style={styles.section}>
          ...
          <P>
            This is a paragraph with a <A href="https://example.com">link to example.com</A> in it.
          </P>
        </SpacedView>
