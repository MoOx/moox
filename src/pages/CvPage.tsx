...
export default function CvPage({
  ...
  return (
    <WebsiteWrapper bare={true}>
      ...
      {/* Page setup for the PDF export: `@page`, `zoom`, print colours. All
          of it is print CSS, which native has no equivalent of and no need
          for. */}
      {Platform.OS === "web" ? (
        <style
          dangerouslySetInnerHTML={{
      ...
      {/* No pages to repeat across on native, and `borderImage` is not a
          style React Native understands. */}
      {Platform.OS === "web" ? (
        <div
          aria-hidden="true"
          style={{
        ...
        <View nativeID="cv-content" style={{ gap: size("l") }}>
          <View>
            ...
            <SpacedView vertical="s" gap="xxs">
              ...
              >
                <SVGExternalLink width={16} height={16} color={theme.dynamicColors.textLight1} />
