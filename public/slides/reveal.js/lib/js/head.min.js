...
(function(n, t) {
  ...
  for (
    ...
    for (f in i.browsers[l])
      if (o === f)
        for (
          r(f), g = i.browsers[l][f].min, nt = i.browsers[l][f].max, e = g;
          e <= nt;
          e++
        )
          h > e
...
(function(n, t) {
  ...
  var h = n.document,
    ...
    f = {
      gradient: function() {
        ...
        return (
          (i.cssText = (
            n +
            s.join(
              "gradient(linear,left top,right bottom,from(#9f9),to(#fff));" + n
            ) +
      ...
      rgba: function() {
        return (
          (i.cssText = "background-color:rgba(0,0,0,0.5)"), !!i.backgroundColor
        );
      },
      opacity: function() {
